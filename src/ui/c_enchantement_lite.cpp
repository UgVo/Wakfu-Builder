...
c_enchantement_lite::c_enchantement_lite(QWidget *parent, c_enchantement_effect effect)
    ...
    ui->button->setStyleSheet(QString("Text-align:left; border-radius : 3px; border : 2px solid "
                                      "%1; background-color : %1; color : white;")
...
c_enchantement_lite::~c_enchantement_lite() { delete ui; }
...
void c_enchantement_lite::slot_highLight(bool flag) {
    if (flag) {
        ui->button->setStyleSheet(QString("Text-align:left; border-radius : 3px; border : 2px "
                                          "solid white; background-color : %1; color : white;")
                                      .arg(app_color::grey_blue_3));
        ui->button->setMinimumSize(QSize(220, 0));
    } else {
        ui->button->setStyleSheet(QString("Text-align:left; border-radius : 3px; border : 2px "
                                          "solid %1; background-color : %1; color : white;")
                                      .arg(app_color::grey_blue_3));
        ui->button->setMinimumSize(QSize(200, 0));
    }
}

c_enchantement_effect c_enchantement_lite::effect() const { return _effect; }

int c_enchantement_lite::id() const { return _id; }
