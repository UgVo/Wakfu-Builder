...
c_search_widget::c_search_widget(c_dbmanager *manager, QCompleter *search_completer,
                                 QWidget *parent)
    : QWidget(parent), ui(new Ui::c_search_widget) {
    ui->setupUi(this);
    dbmanager = manager;
    lvl = 100;
    ...
    final = false;
    ui->final_object_check->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/unchecked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/checked.png);}");
    ui->double_slide_bar->setSource(QUrl(QStringLiteral("qrc:/qml/qck_double_slider.qml")));
    slider = ui->double_slide_bar->rootObject();
    QObject::connect(slider, SIGNAL(first_moved(qreal)), this,
                     SLOT(slot_slider_first_moved(qreal)));
    QObject::connect(slider, SIGNAL(second_moved(qreal)), this,
                     SLOT(slot_slider_second_moved(qreal)));
    QObject::connect(ui->lvl_low, SIGNAL(valueChanged(int)), this, SLOT(slot_lvl_low_changed(int)));
    QObject::connect(ui->lvl_high, SIGNAL(valueChanged(int)), this,
                     SLOT(slot_lvl_high_changed(int)));
    QObject::connect(ui->niveau_preDef, &QComboBox::currentTextChanged, this,
                     &c_search_widget::slot_niveau_preDef_changed);
    ...
    setLvl(lvl);
    ui->pb_relique->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/relique_low.png);} QCheckBox {color : grey;}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/relique_high.png);}");
    QObject::connect(ui->pb_relique, &QCheckBox::stateChanged, this,
                     &c_search_widget::slot_rarity_change_state);
    ui->pb_epique->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/epique_low.png);} QCheckBox {color : grey;}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/epique_high.png);}");
    QObject::connect(ui->pb_epique, &QCheckBox::stateChanged, this,
                     &c_search_widget::slot_rarity_change_state);
    ui->pb_legend->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/legendaire_low.png);} QCheckBox {color : grey;}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/legendaire_high.png);} ");
    QObject::connect(ui->pb_legend, &QCheckBox::stateChanged, this,
                     &c_search_widget::slot_rarity_change_state);
    ui->pb_mythique->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/mythique_low.png);} QCheckBox {color : grey;}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/mythique_high.png);} ");
    QObject::connect(ui->pb_mythique, &QCheckBox::stateChanged, this,
                     &c_search_widget::slot_rarity_change_state);
    ui->pb_souvenir->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/souvenir_low.png);} QCheckBox {color : grey;}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/souvenir_high.png);} ");
    QObject::connect(ui->pb_souvenir, &QCheckBox::stateChanged, this,
                     &c_search_widget::slot_rarity_change_state);
    setStyleSheet(QString("c_search_widget {background-color: %1; border: 1px solid %1; "
                          "border-radius: 4px;}  .QWidget.QWidget{background-color: %2; "
                          "border: 1px solid %2; border-radius: 4px;} "
                          ".QSpinBox{background-color: %2; color:white; } "
                          ".QLabel{color:white} .QGroupeBox{color : white}")
    ...
    ui->cb_pet->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallpet_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallpet.png);} ");
    ui->cb_back->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallback_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallback.png);} ");
    ui->cb_belt->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallbelt_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallbelt.png);} ");
    ui->cb_head->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallhead_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallhead.png);} ");
    ui->cb_legs->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smalllegs_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smalllegs.png);} ");
    ui->cb_neck->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallneck_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallneck.png);} ");
    ui->cb_ring->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallring_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallring.png);} ");
    ui->cb_chest->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallchest_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallchest.png);} ");
    ui->cb_2_hands->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smalldoublehand_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smalldoublehand.png);} ");
    ui->cb_accessory->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallaccessory_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallaccessory.png);} ");
    ui->cb_shoulders->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallshoulders_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallshoulders.png);} ");
    ui->cb_first_hand->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallfirsthand_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallfirsthand.png);} ");
    ui->cb_second_hand->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallsecondhand_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallsecondhand.png);} ");
    ui->cb_mount->setStyleSheet(
        "QCheckBox::indicator:unchecked {image: "
        "url(:/images/divers/smallmount_inked.png);}"
        "QCheckBox::indicator:checked {image: "
        "url(:/images/divers/smallmount.png);} ");

    ui->name_search->setPlaceholderText("Recherche par nom");
    ui->name_search->setStyleSheet(
        QString(" QLineEdit{background-color: %1;  border: 1px solid %1; color: "
                "white;   border-radius: 3px;}"
                "name_search::placeholder {color : white;} ")
            .arg(app_color::grey_blue));
    ...
    QObject::connect(ui->pb_add_condition, &QPushButton::clicked, this,
                     &c_search_widget::slot_new_condi_row);

    completer = search_completer;
    ui->name_search->setCompleter(completer);
}

c_search_widget::~c_search_widget() { delete ui; }
...
void c_search_widget::slot_load_search_position(QString position) {
    ...
    QList<int> itemType;
    QString position_elem = c_item::mapPositionToType.value(position);
    itemType.append(c_item::mapTypeToId.value(position_elem));

    if (ui->cb_2_hands->isChecked()) itemType.append(c_item::mapTypeToId.value("TWO_HAND_WEAPON"));
    ...
    QList<int> item_list = dbmanager->getid_item_from_actions(
        caract, rarities, itemType, {ui->lvl_low->value(), ui->lvl_high->value()},
        ui->name_search->text(), ui->final_object_check->checkState() == Qt::CheckState::Checked);
...
void c_search_widget::slot_rarity_change_state(bool checked) {
    ...
    QString name = sender->text().replace(QRegularExpression("[éèëê]"), "e").toLower();
    if (checked) {
        sender->setStyleSheet(
            QString("QCheckBox::indicator:unchecked {image: "
                    "url(:/images/divers/%1_low.png);}"
                    "QCheckBox::indicator:checked {image: "
                    "url(:/images/divers/%1_high.png);} QCheckBox {color : white;}")
                .arg(name));
    } else {
        sender->setStyleSheet(
            QString("QCheckBox::indicator:unchecked {image: "
                    "url(:/images/divers/%1_low.png);}"
                    "QCheckBox::indicator:checked {image: "
                    "url(:/images/divers/%1_high.png);} QCheckBox {color : grey;}")
                .arg(name));
    }
}
...
void c_search_widget::slot_search() {
    QList<int> itemType;
    if (ui->cb_back->isChecked()) itemType.append(c_item::mapTypeToId.values("BACK"));
    if (ui->cb_pet->isChecked()) itemType.append(c_item::mapTypeToId.values("PET"));
    if (ui->cb_belt->isChecked()) itemType.append(c_item::mapTypeToId.values("BELT"));
    if (ui->cb_2_hands->isChecked()) itemType.append(c_item::mapTypeToId.value("TWO_HAND_WEAPON"));
    if (ui->cb_ring->isChecked()) itemType.append(c_item::mapTypeToId.values("RING"));
    if (ui->cb_first_hand->isChecked())
        itemType.append(c_item::mapTypeToId.values("ONE_HAND_WEAPON"));
    if (ui->cb_second_hand->isChecked()) itemType.append(c_item::mapTypeToId.values("SECOND_HAND"));
    if (ui->cb_legs->isChecked()) itemType.append(c_item::mapTypeToId.values("LEGS"));
    if (ui->cb_neck->isChecked()) itemType.append(c_item::mapTypeToId.values("NECK"));
    if (ui->cb_head->isChecked()) itemType.append(c_item::mapTypeToId.values("HEAD"));
    if (ui->cb_chest->isChecked()) itemType.append(c_item::mapTypeToId.values("CHEST"));
    if (ui->cb_shoulders->isChecked()) itemType.append(c_item::mapTypeToId.values("SHOULDERS"));
    if (ui->cb_accessory->isChecked()) itemType.append(c_item::mapTypeToId.values("ACCESSORY"));
    if (ui->cb_mount->isChecked()) itemType.append(c_item::mapTypeToId.values("MOUNT"));
    ...
    QList<int> item_list = dbmanager->getid_item_from_actions(
        caract, rarities, itemType, {ui->lvl_low->value(), ui->lvl_high->value()},
        ui->name_search->text(), ui->final_object_check->isChecked());
    emit new_search_result(item_list);
}
...
void c_search_widget::init_comboBox(QComboBox *cb) {
    cb->setStyleSheet(QString("QComboBox { background-color: %1;  border: 1px solid %1; "
                              "color:white;   border-radius: 3px;} QComboBox::drop-down { "
                              "width: 16px;    border: %1 solid %1; "
                              "border-bottom-right-radius: 3px;} QComboBox::down-arrow {image: "
                              "url(:/images/divers/down_arrow.png);} QComboBox::down-arrow:on "
                              "{image: url(:/images/divers/up_arrow.png);} QComboBox::item{ "
                              "border: 0px solid black } ")
                          .arg(app_color::grey_blue));
    cb->view()->setStyleSheet(
        QString("QAbstractItemView {background-color : %1; "
                "selection-background-color: %2; outline: 0px; border: 1px solid "
                "%1; border-radius: 3px;}")
            .arg(app_color::grey_blue)
            .arg(app_color::green_blue));
    for (int i = 0; i < cb->count(); ++i) {
        cb->setItemData(i, QBrush(QColor("white")), Qt::ForegroundRole);
    }
}
...
void c_search_widget::slot_combi_search() {
    ...
    if (ui->cb_first_carac->currentIndex() != 0)
        caract_name.append(ui->cb_first_carac->currentText());
    ...
    if (ui->tri_best_combi_check->isChecked()) {
        QList<int> item_list = dbmanager->getid_item_from_actions_sorted(
            caract_name, rarities, itemType, {ui->lvl_low->value(), ui->lvl_high->value()},
            ui->name_search->text(), ui->final_object_check->isChecked(),
            caract_condi.mid(0, caract_name.size() - 1));
        emit new_search_result_sorted(item_list);
    } else {
        QList<int> item_list = dbmanager->getid_item_from_actions(
            caract_name, rarities, itemType, {ui->lvl_low->value(), ui->lvl_high->value()},
            ui->name_search->text(), ui->final_object_check->isChecked(), caract_condi);
        emit new_search_result(item_list);
    }
}
