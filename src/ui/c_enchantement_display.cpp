...
c_enchantement_display::c_enchantement_display(QWidget* parent, c_dbmanager* manager,
                                               c_build* build)
    ...
    foreach (c_enchantement_effect effect, res) {
        ...
        QObject::connect(effect_map.last(), &c_enchantement_lite::clicked, this,
                         &c_enchantement_display::slot_effectClicked);
        switch (effect.color()) {
            case 1:
    ...
    item_slots_map.insert("HEAD", new c_enchantement_item(this, "HEAD"));
    ui->layout_slots->insertWidget(1, item_slots_map["HEAD"]);
    item_slots_map.insert("NECK", new c_enchantement_item(this, "NECK"));
    ui->layout_slots->insertWidget(2, item_slots_map["NECK"]);
    item_slots_map.insert("BACK", new c_enchantement_item(this, "BACK"));
    ui->layout_slots->insertWidget(3, item_slots_map["BACK"]);
    item_slots_map.insert("SHOULDERS", new c_enchantement_item(this, "SHOULDERS"));
    ui->layout_slots->insertWidget(4, item_slots_map["SHOULDERS"]);
    item_slots_map.insert("CHEST", new c_enchantement_item(this, "CHEST"));
    ui->layout_slots->insertWidget(5, item_slots_map["CHEST"]);
    item_slots_map.insert("BELT", new c_enchantement_item(this, "BELT"));
    ui->layout_slots->insertWidget(6, item_slots_map["BELT"]);
    item_slots_map.insert("LEFT_HAND", new c_enchantement_item(this, "LEFT_HAND"));
    ui->layout_slots->insertWidget(7, item_slots_map["LEFT_HAND"]);
    item_slots_map.insert("RIGHT_HAND", new c_enchantement_item(this, "RIGHT_HAND"));
    ui->layout_slots->insertWidget(8, item_slots_map["RIGHT_HAND"]);
    item_slots_map.insert("LEGS", new c_enchantement_item(this, "LEGS"));
    ui->layout_slots->insertWidget(9, item_slots_map["LEGS"]);
    item_slots_map.insert("FIRST_WEAPON", new c_enchantement_item(this, "FIRST_WEAPON"));
    ...
    foreach (c_enchantement_item* item, item_slots_map) {
        QObject::connect(item, &c_enchantement_item::positionSelected, this,
                         &c_enchantement_display::slot_positionSelected);
        QObject::connect(item, &c_enchantement_item::enchantSetUpdated, this,
                         &c_enchantement_display::slot_enchantSetUpdated);
    }
}

c_enchantement_display::~c_enchantement_display() { delete ui; }

c_enchantement_effect c_enchantement_display::selected_effect() const { return _selected_effect; }
