...
c_item_model::c_item_model(c_dbmanager *_manager, QObject *parent) : QAbstractTableModel(parent) {
    manager = _manager;
...
int c_item_model::rowCount(const QModelIndex & /*parent*/) const { return data_list.size(); }

int c_item_model::columnCount(const QModelIndex & /*parent*/) const { return 12; }
...
c_item c_item_model::itemFromId(int id) { return c_item(); }
